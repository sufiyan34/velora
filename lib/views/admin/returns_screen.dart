...
import 'package:e_commerce/views/admin/return_detail_drawer.dart';
import 'package:e_commerce/views/admin/return_row.dart';
...
class ReturnsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.isRegistered<AdminReturnsController>()
        ? Get.find<AdminReturnsController>()
        : Get.put(AdminReturnsController(), permanent: true);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              AdminSearchField(
                hintText: 'Search by order, item or reason…',
      ...
      children: [
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Returns', style: AdminText.display(26)),
              const SizedBox(height: 4),
              Obx(
                () => Text(
                  '${controller.returns.length} total · '
                  '${controller.counts[ReturnStatuses.pending] ?? 0} pending review',
...
class _StatusTabs extends StatelessWidget {
  ...
  static const _tabs = <String>['all', ...ReturnStatuses.all];
